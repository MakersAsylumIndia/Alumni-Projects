...
#define BLYNK_TEMPLATE_ID "TMPLJ1Iwvwh5"
#define BLYNK_DEVICE_NAME "My Device"
#define BLYNK_AUTH_TOKEN "fK-rX8nbXdjov-ZdDB2kGUx-CgO6AQuE"
...
void logEvent1() {
  Blynk.logEvent("bpm_alarm", "30 seconds have passed");
}
...
void setup() {
  ...
  // timer.setInterval(30000L, logEvent1);
  timer.setInterval(200L, calculateBeat);
